...
class test_str(unittest.TestCase):
    ...
    def test_str(self):
        self.assertEqual(str(self.rect), "[Rectangle] (1) 0/0 - 1/2")

    def test_str1(self):
        self.assertEqual(str(self.rect1), "[Rectangle] (2) 5/0 - 3/4")

    def test_str2(self):
        self.assertEqual(str(self.rect2), "[Rectangle] (3) 7/8 - 5/6")

    def test_str3(self):
        self.assertEqual(str(self.rect3), "[Rectangle] (10) 3/4 - 1/2")

    def test_str4(self):
        self.assertEqual(str(self.rect4), "[Rectangle] (4) 5/0 - 1/2")
